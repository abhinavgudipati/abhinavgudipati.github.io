  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <section className="mb-16">
        <div className="mb-6">
          <div className="w-40 h-40 rounded-full overflow-hidden border-2 border-gray-100">
            <img
              src="/photo2.jpg.jpg"
              alt="Abhinav Gudipati"
              style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "55% 0%", transform: "scale(1.6)", transformOrigin: "55% 0%" }}
            />
          </div>
        </div>
